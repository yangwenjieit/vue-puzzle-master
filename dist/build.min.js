...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\ywj\\springBoot\\puzzle\\vue-puzzle-master\\src\\App.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js?sourceMap!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-471d384e&file=App.vue!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./App.vue", function() {
				var newContent = require("!!../node_modules/css-loader/index.js?sourceMap!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-471d384e&file=App.vue!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./App.vue");
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        render: function render() {
	            ...
	            for (j; j < puzzleArr.length; j++) {
	                var content = { text: puzzleArr[j], pic: '../../src/assets/img/' + puzzleArr[j] + '.png' };
	                puzzleContent.push(content);
	            }
	        ...
	        passFn: function passFn() {
	            if (this.puzzles[8] === '') {
	                ...
	                if (isPass) {
	                    var message = ['给你一个超大的么么哒！', '厉害了我的丹妹儿！', '今天有想我吗？', '想我就可以再玩一次！', '爱你哟'];
	                    var num = Math.random() * 5 + 0;
	                    num = parseInt(num, 10);
	                    alert(message[num]);
	                }
